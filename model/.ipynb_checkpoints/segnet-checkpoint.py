...
from keras.layers import Input, concatenate, Conv2D, MaxPooling2D, Activation, UpSampling2D, BatchNormalization, LocallyConnected2D, add
...
def get_segnet(input_shape=(512, 512, 3),
                 num_classes=1):
    ...
    center = BatchNormalization()(center)
    center = Activation('relu')(center)
    center = MaxPooling2D((2, 2), strides=(2, 2))(center)
    # center
    center = UpSampling2D((2, 2))(center)
    center = Conv2D(256, (3, 3), padding='same')(center)
    center = BatchNormalization()(center)
    center = Activation('relu')(center)
    center = Conv2D(256, (3, 3), padding='same')(center)
